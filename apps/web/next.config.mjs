...
const SECURITY_HEADERS = [
  ...
  // 'unsafe-inline' is required — Next.js injects inline hydration scripts
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https: https://www.google-analytics.com https://*.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://tagassistant.google.com",
