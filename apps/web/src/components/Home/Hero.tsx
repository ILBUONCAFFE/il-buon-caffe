...
const heroImages = [
  { src: `${R2}/categories/kawa.webp`, alt: "Kawa specialty", label: "Kawa" },
  { src: `${R2}/categories/wino.webp`, alt: "Włoskie wina", label: "Wino" },
  { src: `${R2}/categories/delikatesy.webp`, alt: "Włoskie delikatesy", label: "Delikatesy" },
];
  ...
  return (
    <section className="relative bg-[#f3eee8] dark:bg-brand-950 border-b border-brand-100 dark:border-white/5 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none" aria-hidden="true">
        ...
        {/* Diagonal pinstripe pattern — subtle, paper-like */}
        <div
        ...
        {/* Giant outline wordmark — editorial magazine feel */}
        ...
        {/* Top-right small badge area — corner mark */}
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 pt-20 md:pt-24 pb-40 md:pb-48 min-h-[88vh] flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center w-full">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Inline stats strip — makes it obvious this is a shop */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              {[
                ...
                <div key={s.l}>
                  <div className="font-serif text-2xl md:text-3xl text-brand-900 dark:text-white tracking-tight">
                    {s.n}
                  </div>
          ...
          {/* Right — offset image stack (span 5) */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            {/* Smaller image — bottom left offset */}
            <motion.div
              initial={{ y: 30, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
      ...
      {/* ── Bottom marquee ticker — category scroll ── */}
