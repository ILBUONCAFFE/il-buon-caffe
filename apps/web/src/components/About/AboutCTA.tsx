  ...
  return (
    <section className="relative bg-brand-950 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 py-24 md:py-32">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif text-white leading-[1.05] mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Kawa, wina, oliwy, delikatesy — do kupienia bez zamawiania online
                </p>
              </div>
            </div>
